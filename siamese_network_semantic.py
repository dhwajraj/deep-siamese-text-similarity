...
class SiameseLSTMw2v(object):
    ...
    def __init__(
        ...
        with tf.name_scope("output"):
            self.out1=self.BiRNN(self.embedded_words1, self.dropout_keep_prob, "side1", embedding_size, sequence_length)
            self.out2=self.BiRNN(self.embedded_words2, self.dropout_keep_prob, "side2", embedding_size, sequence_length)
