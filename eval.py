...
tf.flags.DEFINE_string("vocab_filepath", "runs/1479707352/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1479707352/checkpoints/model-154000", "Load trained model checkpoint (Default: None)")
...
inpH = InputHelper()
x1_test,x2_test,y_test = inpH.getTestDataSet(FLAGS.eval_filepath, FLAGS.vocab_filepath, 50)
...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        predictions = graph.get_operation_by_name("output/Reshape_2").outputs[0]
